...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  //Smart Suggestions with behavior tracking
  bool isLoadingSmartSuggestions = false;
  bool _smartSuggestionsInitialized = false;
  ...
  void initState() {
    ...
    _initializeSmartSuggestions();
  }

  //Initialize Smart Suggestions Engine
  Future<void> _initializeSmartSuggestions() async {
    try {
      await EnhancedSuggestionEngine.initialize();
      setState(() {
        _smartSuggestionsInitialized = true;
      });
      print(' Smart Suggestions Engine initialized in Home');
    } catch (e) {
      print(' Smart Suggestions initialization failed in Home: $e');
      setState(() {
        _smartSuggestionsInitialized = false;
      });
    }
  }
  ...
  // Updated load notification counts method with real message count
  Future<void> _loadNotificationCounts() async {
    try {
      ...
      if (userId != null && mounted) {
        ...
        // Get unread message count from private messaging
        int unreadMessages =
            await DatabaseMethods().getTotalUnreadMessageCount(userId);
  ...
  // Updated allPosts method with private messaging functionality
  Widget allPosts() {
                      ...
                      child: Material(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              // Updated User info header with private messaging
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        // Navigate to private chat if it's not the current user
                                        if (ds["UserId"] != id) {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                  PrivateChatPage(
                                                otherUserId: ds["UserId"],
                                                otherUserName: ds["Name"] ??
                                                    "Unknown User",
                                                otherUserImage:
                                                    ds["UserImage"] ?? "",
                                              ),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          // Smart Suggestions Status Indicator
                          if (_smartSuggestionsInitialized)
                            GestureDetector(
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Row(
                                      children: [
                                        ...
                                        SizedBox(width: 8),
                                        Text(
                                            'Smart suggestions are active! Check below for personalized recommendations.'),
                                      ],
                                    ),
                                    backgroundColor: Colors.green,
                                    behavior: SnackBarBehavior.floating,
                                ...
                                items: [
                                  ...
                                  PopupMenuItem(
                                    child: ListTile(
                                      ...
                                      subtitle: Text("$notificationCount new"),
                                      onTap: () {
                                        Navigator.pop(context);
                              ...
                              child: ClipRRect(
                                ...
                                child: image != null && image!.isNotEmpty
                                    ? Image.network(
                                        ...
                                        errorBuilder:
                                            (context, error, stackTrace) {
                                          return Image.asset("images/boy.jpeg",
                                              height: 50,
                                              width: 50,
                                              fit: BoxFit.cover);
                                        },
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              // AI Badge with Smart Suggestions
                              if (_smartSuggestionsInitialized) ...[
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: "Search destinations, places, users...",
                ...
                // Smart Suggestions Widget Integration
                if (!search) SmartSuggestionsWidget(userId: id),
